...
def main():
    ...
    parser.add_argument(
        '--db_host', help='Specify a db_host (default - postgres)')
    parser.add_argument(
        '--db_name', help='Specify a db_host (default - headphones)')
    parser.add_argument(
        '--db_user', help='Specify a db_host (default - headphones)')
    parser.add_argument(
        '--db_pass', help='Specify a db_host (default - headphones)')
